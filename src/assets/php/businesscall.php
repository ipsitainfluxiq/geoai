...
//print_r($result) ;
curl_setopt($ch, CURLOPT_URL, "http://www.datairis.co/V1/criteria/search/addall/business");
...
//print_r($result) ;
/*totalsearch*/
curl_setopt($ch, CURLOPT_URL, "http://www.datairis.co/V1/search/count/business");
